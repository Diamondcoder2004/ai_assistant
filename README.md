TUSKS строго делай каждую задачу независимо, фиксирую каждый раз сервис
1. ​Hotkeys нужно почеловечески нормальным сделать или не делай если не умеешь
2. Сделай BM25 строгим как раньше, сейчас он слишком толерантный, был патч, где я смягчил его.
3.  Один раз я получил на сайте такой ответ {"query": "подача заявки технологическое присоединение", "k": 5, "pref_weight": 0.5, "hype_weight": 0.0, "lexical_weight": 0.3, "contextual_weight": 0.2}
Только не нужно сильно менять агентов окей, мне очень нравится их стиль общения
4.  В фронтенде нужно Footer сделать пониже по сайту, сейчас он занимает часть экрана, надо чтобы он был внизу и появлялся когда мы скроллим до конца, то есть нужно увеличить длину сайта еще
5.  Убери session badge from History View chat view chat item chat header row
6. 


Объясни на пальцах как работают три агента, @backend/agents/query_generator.py @backend/agents/response_agent.py  @backend/agents/search_agent.py 
Что берут, что возвращают, какие у них инструкции
