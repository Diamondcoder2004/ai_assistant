...
- [ ] Identify opportunities for deep modules (small interface, deep implementation) — see [deep-modules.md](deep-modules.md)
...
Mock at **system boundaries** only — see [mocking.md](mocking.md):
- External APIs, time/randomness, file system
- Don't mock your own classes/modules or internal collaborators
